...
tiff('Gene-level PCoA.tiff', units="in", width=8, height=8, res=300)
GN_PCoA_Plot
dev.off()
...
tiff('Gene Sets Enriched between 10 ppt and 30 ppt.tiff', units="in", width=6, height=6, res=300)
S10vsS30_GSEA_point_plot
dev.off()
...
tiff('Gene Sets Enriched between 20 ppt and 30 ppt.tiff', units="in", width=6, height=6, res=300)
S20vsS30_GSEA_point_plot
dev.off()
...
tiff('Gene Sets Enriched between 10 ppt and 20 ppt.tiff', units="in", width=6, height=6, res=300)
S10vsS20_GSEA_point_plot
dev.off()
...
atp1b4 <- ggplot(VST_cts_boxplot, aes(x=Salinity, y=atp1b4, color=Salinity)) +   
  geom_boxplot() + 
...
cftr <- ggplot(VST_cts_boxplot, aes(x=Salinity, y=cftr, color=Salinity)) +   
  geom_boxplot() + 
  scale_color_manual("Salinity (ppt)", values=c("deeppink", "midnightblue", "blue"), labels=c("10", "20", "30"))+
...
slc26a3 <- ggplot(VST_cts_boxplot, aes(x=Salinity, y=slc26a3, color=Salinity)) +   
  geom_boxplot() + 
  scale_color_manual("Salinity (ppt)", values=c("deeppink", "midnightblue", "blue"), labels=c("10", "20", "30"))+
...
slc9a7 <- ggplot(VST_cts_boxplot, aes(x=Salinity, y=slc9a7, color=Salinity)) +   
  geom_boxplot() + 
  scale_color_manual("Salinity (ppt)", values=c("deeppink", "midnightblue", "blue"), labels=c("10", "20", "30"))+
...
slc26a6 <- ggplot(VST_cts_boxplot, aes(x=Salinity, y=slc26a6, color=Salinity)) +   
  geom_boxplot() + 
  scale_color_manual("Salinity (ppt)", values=c("deeppink", "midnightblue", "blue"), labels=c("10", "20", "30"))+
...
atp6v0a1 <- ggplot(VST_cts_boxplot, aes(x=Salinity, y=atp6v0a1, color=Salinity)) +   
  geom_boxplot() + 
  scale_color_manual("Salinity (ppt)", values=c("deeppink", "midnightblue", "blue"), labels=c("10", "20", "30"))+
...
tiff('Target Osmoregulation Genes Figure.tiff', units="in", width=10, height=10, res=300)
target_osmoregulation_gene_figure
dev.off()
...
cat <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=cat, color=Feeding)) +   
  geom_boxplot() + 
...
lyz <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=lyz, color=Feeding)) +   
  geom_boxplot() + 
  scale_color_manual(name="Feeding Type", limits=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "Eart + MF", "MF"), values=c("green", "brown", "blue", "orange", "purple"),labels=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "EArt + MF", "MF"))+
...
nod1 <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=nod1, color=Feeding)) +   
  geom_boxplot() + 
  scale_color_manual(name="Feeding Type", limits=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "Eart + MF", "MF"), values=c("green", "brown", "blue", "orange", "purple"),labels=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "EArt + MF", "MF"))+
...
sod1 <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=sod1, color=Feeding)) +   
  geom_boxplot() + 
  scale_color_manual(name="Feeding Type", limits=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "Eart + MF", "MF"), values=c("green", "brown", "blue", "orange", "purple"),labels=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "EArt + MF", "MF"))+
...
tlr3 <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=tlr3, color=Feeding)) +   
  geom_boxplot() + 
  scale_color_manual(name="Feeding Type", limits=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "Eart + MF", "MF"), values=c("green", "brown", "blue", "orange", "purple"),labels=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "EArt + MF", "MF"))+
...
tnfaip3 <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=tnfaip3, color=Feeding)) +   
  geom_boxplot() + 
  scale_color_manual(name="Feeding Type", limits=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "Eart + MF", "MF"), values=c("green", "brown", "blue", "orange", "purple"),labels=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "EArt + MF", "MF"))+
...
tiff('Target Immunity Genes Figure.tiff', units="in", width=10, height=10, res=300)
target_immunity_gene_figure
dev.off()
...
elovl5 <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=elovl5
                                      , color=Feeding)) +   geom_boxplot() +
...
acadm <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=fads2, color=Feeding)) +   geom_boxplot() +
  # theme(axis.text.x  = element_text(angle=45, hjust=1)) + 
  scale_color_manual(name="Feeding Type", limits=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "Eart + MF", "MF"), values=c("green", "brown", "blue", "orange", "purple"),labels=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "EArt + MF", "MF"))+
...
fabp1 <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=fabp1, color=Feeding)) +   geom_boxplot() +
  # theme(axis.text.x  = element_text(angle=45, hjust=1)) + 
  scale_color_manual(name="Feeding Type", limits=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "Eart + MF", "MF"), values=c("green", "brown", "blue", "orange", "purple"),labels=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "EArt + MF", "MF"))+
...
fasn <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=fasn, color=Feeding)) +   geom_boxplot() +
  # theme(axis.text.x  = element_text(angle=45, hjust=1)) + 
  scale_color_manual(name="Feeding Type", limits=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "Eart + MF", "MF"), values=c("green", "brown", "blue", "orange", "purple"),labels=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "EArt + MF", "MF"))+
...
fads2 <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=fads2, color=Feeding)) +   geom_boxplot() +
  # theme(axis.text.x  = element_text(angle=45, hjust=1)) + 
  scale_color_manual(name="Feeding Type", limits=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "Eart + MF", "MF"), values=c("green", "brown", "blue", "orange", "purple"),labels=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "EArt + MF", "MF"))+
...
elovl6 <- ggplot(VST_cts_boxplot, aes(x=Days_Post_Hatch, y=elovl6, color=Feeding)) +   geom_boxplot() +
  # theme(axis.text.x  = element_text(angle=45, hjust=1)) + 
  scale_color_manual(name="Feeding Type", limits=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "Eart + MF", "MF"), values=c("green", "brown", "blue", "orange", "purple"),labels=c("GW + Rot", "GW + Art + EArt", "Art + EArt + MF", "EArt + MF", "MF"))+
...
tiff('Target Fatty Acid Genes Figure.tiff', units="in", width=10, height=10, res=300)
target_fatty_acid_genes_figure
dev.off()
...
tiff('elovl5 vs NFAs JA.tiff', units="in", width=10, height=10, res=300)
elovl5_vs_NFAs_figure_JA
dev.off()
...
tiff('elovl5 vs PFAs JA.tiff', units="in", width=10, height=10, res=300)
elovl5_vs_PFAs_figure_JA
dev.off()
...
tiff('elovl5 vs TFAs JA.tiff', units="in", width=10, height=10, res=300)
elovl5_vs_TFAs_figure_JA
dev.off()
...
tiff('fads2 vs NFAs JA.tiff', units="in", width=10, height=10, res=300)
fads2_vs_NFAs_figure_JA
dev.off()
...
tiff('fads2 vs PFAs JA.tiff', units="in", width=10, height=10, res=300)
fads2_vs_PFAs_figure_JA
dev.off()
...
tiff('fads2 vs TFAs JA.tiff', units="in", width=10, height=10, res=300)
fads2_vs_TFAs_figure_JA
dev.off()
